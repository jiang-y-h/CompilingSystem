...
@k = constant float 3.000000 e+00, align 4
;全局变量声明 float a=2.0;
@a = global float 3.000000 e+00, align 4
;全局变量声明 b [2]={5 ,8};
@b = global [2 x i32 ] [ i32 5 , i32 8 ] , align 4

; 定义函数 float func (int d)
define f l o a t @func (i32 %0){
    %1 = alloca i32 , align 4 ;为传入的参数分配地址
    store i32 %0, i32 ∗ %1, align 4;传参
    ...
    ;实现if(d==b[0]||d==b[1])
    %cmp1 = icmp eq i32 %1, %b_0
    %cmp2 = icmp eq i32 %1, %b_1
    %or = or i1 %cmp1, %cmp2
...
define i32 @main(){
    ...
    %2 = call i32 @getint ();
    store i32 %2, i32 ∗ %n, align 4 ;n=getint()
    br %5
